...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        if(len < 9 || len > 16)
        {
            System.out.println("Invalid Password! Password must have a length of 8 to 16 characters");
            System.exit(0);
        }
        ...
        if(count.size() < 3)
        {
            System.out.println("Invalid Password! Password must have 3 different Character combinations");
            System.exit(0);
        }
